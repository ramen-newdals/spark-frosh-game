...
export var StoryDatabase = [
  new StoryFrame("Welcome to f!rosh week!", ["Okay!"], ['Made by Spark.'], [], 'https://picsum.photos/200/300', [], TimeBucket.START),
  ...
  new StoryFrame("text", ["Choice 1", "Choice 2", "Choice 3"], ['Outcome 1', 'Outcome 2', 'Outcome 3'], [], 'https://picsum.photos/200/300', [], TimeBucket.FROSH_WEEK),
  new StoryFrame("text", ["Choice 1", "Choice 2", "Choice 3"], ['Outcome 1', 'Outcome 2', 'Outcome 3'], [], 'https://picsum.photos/200/300', [], TimeBucket.FROSH_WEEK),
]
